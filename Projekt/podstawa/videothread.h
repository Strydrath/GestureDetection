...
private:
    ...
    void feature_detection(cv::Mat img,cv::Mat mask, cv::Rect &rect, cv::Rect &rect2, std::vector<cv::Point> &hull_points, std::vector<cv::Point> &def_points);
    ...
    void handleMouseMove(cv::Mat img,int x, int y);
