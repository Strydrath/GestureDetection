...
QT_MOC_LITERAL(7, 82, 13), // "y_mean_signal"
QT_MOC_LITERAL(8, 96, 1), // "y"
QT_MOC_LITERAL(9, 98, 12), // "getScalarMin"
QT_MOC_LITERAL(10, 111, 10), // "cv::Scalar"
QT_MOC_LITERAL(11, 122, 2), // "s1"
QT_MOC_LITERAL(12, 125, 12) // "getScalarMax"

    },
    "videothread\0NewCamImg\0\0gestureDetected1\0"
    "gesture\0gestureDetected2\0gestureDetected3\0"
    "y_mean_signal\0y\0getScalarMin\0cv::Scalar\0"
    "s1\0getScalarMax"
};
...
void videothread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->y_mean_signal((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->getScalarMin((*reinterpret_cast< cv::Scalar(*)>(_a[1]))); break;
        case 6: _t->getScalarMax((*reinterpret_cast< cv::Scalar(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&videothread::y_mean_signal)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void videothread::y_mean_signal(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
